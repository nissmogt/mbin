...
######################################################################################
## This program filters and cleans Pfam domain sequences taking off the dots "." and ##
...
size = open(data,"r")
limit = int(raw_input("Maximum number of continuous gaps per sequence: "))
...
output = open(data+"_f"+str(limit),"w")
...
print "\nFile saved as: "+data+"_f"+str(limit)+"\n"
